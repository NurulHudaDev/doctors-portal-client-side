            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 justify-items-center'>
                        ...
                        <input type="text" name='name' placeholder="Your Name" className="input w-full max-w-xs border border-slate-300" />
                        <input type="email" name='email' placeholder="Email Addres" className="input w-full max-w-xs border border-slate-300" />
